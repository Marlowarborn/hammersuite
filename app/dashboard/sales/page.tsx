...
export default function SalesPage() {
  ...
  return (
    <div className="fade-up">
      ...
      {showCreate && (
        <div onClick={() => setShowCreate(false)} style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.4)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9999, padding: 24 }}>
          <div onClick={e => e.stopPropagation()} style={{ background: "var(--white)", borderRadius: "var(--radius-lg)", padding: 32, width: "100%", maxWidth: 520, boxShadow: "var(--shadow-lg)", maxHeight: "85vh", overflowY: "auto", position: "relative" }}>
